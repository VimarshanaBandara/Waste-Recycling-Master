...
import 'package:dropdown_field/helpers/app_helper.dart';
import 'package:dropdown_field/helpers/camera_helper.dart';
import 'package:dropdown_field/helpers/tflite_helper.dart';
import 'package:dropdown_field/models/result.dart';
...
class _DetectScreenPageState extends State<DetectScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Classifier Scanner",style: TextStyle(color: Colors.black),),
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: outputs != null && outputs.isNotEmpty
              ...
              : Center(
                  child: Text("Please Wait for Detect",
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 20.0,
                      ))),
