...
class Ke1 extends StatefulWidget {


  @override
  _Ke1State createState() => _Ke1State();
}

class _Ke1State extends State<Ke1> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        ...
        elevation: 0.0,
        toolbarHeight: 70,
        title:const Text("Kegalle - Rambukkana"),
        centerTitle: true,
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('Smart Polypackaging\n Hurimaluwa\nRambukkana',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),) ,//COMPANY NAME 02
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('0777-846114',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),
              ) ,//CONTACT NUMBER 02
              SizedBox(height:30.0,),
              Padding(
                  padding: EdgeInsets.only(left: 15.0,right: 15.0),
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('Polythene for concerete laying',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),
              ) ,//PRODUCT 02
