...
class Bt16 extends StatefulWidget {


  @override
  _Bt16State createState() => _Bt16State();
}

class _Bt16State extends State<Bt16> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
          ...
          elevation: 0.0,
          toolbarHeight: 70,
          title:const Text("Batticaloa - Sathrukondan"),
          centerTitle: true,
