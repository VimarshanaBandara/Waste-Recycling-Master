...
class Bt14 extends StatefulWidget {


  @override
  _Bt14State createState() => _Bt14State();
}

class _Bt14State extends State<Bt14> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
          ...
          elevation: 0.0,
          toolbarHeight: 70,
          title:const Text("Batticaloa - New Kattankudy"),
          centerTitle: true,
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('S.M.Mansoor\nMohideen Palli Road\nNew Kattankudy',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),) ,//COMPANY NAME 02
