...
class Gl9 extends StatefulWidget {


  @override
  _Gl9State createState() => _Gl9State();
}

class _Gl9State extends State<Gl9> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
          ...
          elevation: 0.0,
          toolbarHeight: 70,
          title:const Text("Galle - Uluvitike"),
          centerTitle: true,
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('M.Ferzi\nNavinna\nUluvitike',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),) ,//COMPANY NAME 02
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('077-6424770',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),
              ) ,//CONTACT NUMBER 02
              SizedBox(height:30.0,),
              Padding(
                  padding: EdgeInsets.only(left: 15.0,right: 15.0),
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('PET,PP,PS,HIPS',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),
              ) ,//MATERIALS 02
              SizedBox(height:30.0,),
              Padding(
                  padding: EdgeInsets.only(left: 15.0,right: 15.0),
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('Crushed and sold',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),
              ) ,//PRODUCT 02
