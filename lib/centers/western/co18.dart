...
class Co18 extends StatefulWidget {


  @override
  _Co18State createState() => _Co18State();
}

class _Co18State extends State<Co18> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        ...
        elevation: 0.0,
        toolbarHeight: 70,
        title:const Text("Colombo - Ranala"),
        centerTitle: true,
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('M.M.J.Services\nBatewela\nRanala',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),) ,//COMPANY NAME 02
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('716076794',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),
              ) ,//CONTACT NUMBER 02
              SizedBox(height:30.0,),
              Padding(
                  padding: EdgeInsets.only(left: 15.0,right: 15.0),
