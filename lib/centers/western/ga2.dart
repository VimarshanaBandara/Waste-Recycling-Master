...
class Ga2 extends StatefulWidget {


  @override
  _Ga2State createState() => _Ga2State();
}

class _Ga2State extends State<Ga2> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        ...
        elevation: 0.0,
        toolbarHeight: 70,
        title:const Text("Gampaha - Delgoda"),
        centerTitle: true,
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('Piyashantha\nAhugammana\nDelgoda',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),
              ) ,//COMPANY NAME 02
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('011-2403649\n077-3047639',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),
              ) ,//CONTACT NUMBER 02
              SizedBox(height:30.0,),
              Padding(
                  padding: EdgeInsets.only(left: 15.0,right: 15.0),
              ...
              Padding(
                padding: EdgeInsets.only(left: 15.0,right: 15.0),
                child: Text('Pellets and Polythene',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),
              ) ,//PRODUCT 02
